...
// #else
#include "sensor_ov08a10_hisense_mipi_raw_2lane.h"
//#endif
...
static const cmr_u16 ov08a10_hisense_pd_is_right[] = {1, 0, 0, 1};

static const cmr_u16 ov08a10_hisense_pd_col[] = {14, 14, 6, 6};

static const cmr_u16 ov08a10_hisense_pd_row[] = {2, 6, 10, 14};

static const struct pd_pos_info ov08a10_hisense_pd_pos_l[] = {
    {14, 6}, {6, 10},
};

static const struct pd_pos_info ov08a10_hisense_pd_pos_r[] = {
    {14, 2}, {6, 14},
};
static const cmr_u32 ov08a10_hisense_pd_sns_mode[] = {
    SENSOR_PDAF_MODE_DISABLE, SENSOR_PDAF_MODE_DISABLE,
    SENSOR_PDAF_MODE_DISABLE, SENSOR_PDAF_MODE_ENABLE
};

struct sensor_pdaf_info ov08a10_hisense_pdaf_info_array[] = {
    ...
    {
	.pd_is_right = (cmr_u16 *)ov08a10_hisense_pd_is_right,
	.pd_pos_row = (cmr_u16 *)ov08a10_hisense_pd_row,
	.pd_pos_col = (cmr_u16 *)ov08a10_hisense_pd_col,
	.pd_pos_r = (struct pd_pos_info *)ov08a10_hisense_pd_pos_r,
	.pd_pos_l = (struct pd_pos_info *)ov08a10_hisense_pd_pos_l,
	.pd_pos_size = NUMBER_OF_ARRAY(ov08a10_hisense_pd_pos_r),
	.pd_offset_x = 0,
	.pd_offset_y = 8,
	.pd_end_x = 3264,
	.pd_end_y = 2448,
	...
	.sns_mode = ov08a10_hisense_pd_sns_mode,
...
static struct sensor_pdaf_info_tab ov08a10_hisense_pdaf_info_tab = {
    .sns_mode_num = NUMBER_OF_ARRAY(ov08a10_hisense_pd_sns_mode),
	.pd_sns_mode = ov08a10_hisense_pd_sns_mode,
	.pdaf_init_index = 3,
	.pd_init_size_w = SNAPSHOT_WIDTH,
	.pd_init_size_h = SNAPSHOT_HEIGHT,
	.pd_info_tab = ov08a10_hisense_pdaf_info_array,
};

static cmr_int ov08a10_hisense_drv_get_pdaf_info(cmr_handle handle, void *param) {
    ...
    pdaf_info_tab->sns_mode_num = ov08a10_hisense_pdaf_info_tab.sns_mode_num;
    pdaf_info_tab->pd_sns_mode = ov08a10_hisense_pdaf_info_tab.pd_sns_mode;
    pdaf_info_tab->pdaf_init_index = ov08a10_hisense_pdaf_info_tab.pdaf_init_index;
    pdaf_info_tab->pd_init_size_w = ov08a10_hisense_pdaf_info_tab.pd_init_size_w;
    pdaf_info_tab->pd_init_size_h = ov08a10_hisense_pdaf_info_tab.pd_init_size_h;
    pdaf_info_tab->pd_info_tab = ov08a10_hisense_pdaf_info_tab.pd_info_tab;

    pd_info_num = ov08a10_hisense_pdaf_info_tab.sns_mode_num;
...
static cmr_int ov08a10_drv_access_val(cmr_handle handle, cmr_uint param) {
  ...
  case SENSOR_VAL_TYPE_GET_PDAF_INFO: //18
    ret = ov08a10_hisense_drv_get_pdaf_info(handle, param_ptr->pval);
    break;
  case SENSOR_VAL_TYPE_SET_SENSOR_CLOSE_FLAG://19
    ret = sns_drv_cxt->is_sensor_close = 1;
    break;
  case SENSOR_VAL_TYPE_GET_OIS_INFO:
    *((cmr_u8 *)param_ptr->pval) = (s_ov08a10_static_info->static_info.ois_supported);
    break;
  default:
    break;
  }
...
static cmr_int ov08a10_drv_set_master_FrameSync(cmr_handle handle,
  ...
  SENSOR_LOGI("E");
	hw_sensor_write_reg(sns_drv_cxt->hw_handle, 0x3002, 0x08);
	hw_sensor_write_reg(sns_drv_cxt->hw_handle, 0x3830, 0x16);
	hw_sensor_write_reg(sns_drv_cxt->hw_handle, 0x3831, 0xfa);// vts-0x20
	hw_sensor_write_reg(sns_drv_cxt->hw_handle, 0x382f, 0x88);// vts-0x20
