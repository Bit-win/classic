...
#define PREVIEW_MIPI_PER_LANE_BPS 1600
#define SNAPSHOT_MIPI_PER_LANE_BPS 1600

/*line time unit: 1ns*/
#define VIDEO_LINE_TIME 11275
#define PREVIEW_LINE_TIME 11250
#define SNAPSHOT_LINE_TIME 11250

/* frame length*/
#define VIDEO_FRAME_LENGTH 2956
#define PREVIEW_FRAME_LENGTH 2956
#define SNAPSHOT_FRAME_LENGTH 5912
...
static SENSOR_REG_T ov08a10_hisense_grp_hold_start_reg[] = {

};

static struct sensor_i2c_reg_tab ov08a10_hisense_grp_hold_start_tab = {
    .settings = ov08a10_hisense_grp_hold_start_reg,
    .size = ARRAY_SIZE(ov08a10_hisense_grp_hold_start_reg),
};

static SENSOR_REG_T ov08a10_hisense_grp_hold_end_reg[] = {

};

static struct sensor_i2c_reg_tab ov08a10_hisense_grp_hold_end_tab = {
    .settings = ov08a10_hisense_grp_hold_end_reg,
    .size = ARRAY_SIZE(ov08a10_hisense_grp_hold_end_reg),
};
...
static struct sensor_aec_i2c_tag ov08a10_aec_info = {
    ...
    .grp_hold_start = &ov08a10_hisense_grp_hold_start_tab,
    .grp_hold_end = &ov08a10_hisense_grp_hold_end_tab,
};
