...
static void
ov08a10_back_drv_write_reg2sensor(cmr_handle handle,
 ...
 * please modify this function acording your spec
 *============================================================================*/
static void ov08a10_back_drv_write_frame_length(
 ...
 *============================================================================*/
static void
ov08a10_back_drv_calc_exposure(cmr_handle handle, cmr_u32 shutter,
...
static const cmr_u16 ov08a10_back_pd_is_right[] = {1, 0, 0, 1};

static const cmr_u16 ov08a10_back_pd_col[] = {14, 14, 6, 6};

static const cmr_u16 ov08a10_back_pd_row[] = {2, 6, 10, 14};

static const struct pd_pos_info ov08a10_back_pd_pos_l[] = {
    {14, 6}, {6, 10},
};

static const struct pd_pos_info ov08a10_back_pd_pos_r[] = {
    {14, 2}, {6, 14},
};
static const cmr_u32 ov08a10_back_pd_sns_mode[] = {
    SENSOR_PDAF_MODE_DISABLE, SENSOR_PDAF_MODE_DISABLE, SENSOR_PDAF_MODE_DISABLE,
    SENSOR_PDAF_MODE_ENABLE};

struct sensor_pdaf_info ov08a10_back_pdaf_info_array[] = {
    ...
    {
	.pd_is_right = (cmr_u16 *)ov08a10_back_pd_is_right,
	.pd_pos_row = (cmr_u16 *)ov08a10_back_pd_row,
	.pd_pos_col = (cmr_u16 *)ov08a10_back_pd_col,
	.pd_pos_r = (struct pd_pos_info *)ov08a10_back_pd_pos_r,
	.pd_pos_l = (struct pd_pos_info *)ov08a10_back_pd_pos_l,
	.pd_pos_size = NUMBER_OF_ARRAY(ov08a10_back_pd_pos_r),
	.pd_offset_x = 0,
	.pd_offset_y = 8,
	.pd_end_x = 3264,
	.pd_end_y = 2448,
	...
	.sns_mode = ov08a10_back_pd_sns_mode,
...
static struct sensor_pdaf_info_tab ov08a10_back_pdaf_info_tab = {
    .sns_mode_num = NUMBER_OF_ARRAY(ov08a10_back_pd_sns_mode),
	.pd_sns_mode = ov08a10_back_pd_sns_mode,
	.pdaf_init_index = 3,
	.pd_init_size_w = SNAPSHOT_WIDTH,
	.pd_init_size_h = SNAPSHOT_HEIGHT,
	.pd_info_tab = ov08a10_back_pdaf_info_array,
};

static cmr_int ov08a10_back_drv_get_pdaf_info(cmr_handle handle, void *param) {
    ...
    pdaf_info_tab->sns_mode_num = ov08a10_back_pdaf_info_tab.sns_mode_num;
    pdaf_info_tab->pd_sns_mode = ov08a10_back_pdaf_info_tab.pd_sns_mode;
    pdaf_info_tab->pdaf_init_index = ov08a10_back_pdaf_info_tab.pdaf_init_index;
    pdaf_info_tab->pd_init_size_w = ov08a10_back_pdaf_info_tab.pd_init_size_w;
    pdaf_info_tab->pd_init_size_h = ov08a10_back_pdaf_info_tab.pd_init_size_h;
    pdaf_info_tab->pd_info_tab = ov08a10_back_pdaf_info_tab.pd_info_tab;

    pd_info_num = ov08a10_back_pdaf_info_tab.sns_mode_num;
...
static cmr_int ov08a10_back_drv_get_static_info(cmr_handle handle,
                                                cmr_u32 *param) {
    cmr_int rtn = SENSOR_SUCCESS;
...
static cmr_int ov08a10_back_drv_get_fps_info(cmr_handle handle,
                                             cmr_u32 *param) {
    cmr_int rtn = SENSOR_SUCCESS;
...
static cmr_int ov08a10_back_drv_dump_trace(cmr_handle handle, cmr_u32 *param) {
    cmr_int rtn = SENSOR_SUCCESS;
    cmr_u16 value1 = 0, value2 = 0;
    SENSOR_IC_CHECK_HANDLE(handle);
    struct sensor_ic_drv_cxt *sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;

    value1 = hw_sensor_read_reg(sns_drv_cxt->hw_handle, 0x485E);
    value2 = hw_sensor_read_reg(sns_drv_cxt->hw_handle, 0x485F);
    SENSOR_LOGI("FRM_CNT 0x485E:0x%x 0x485F:0x%x", value1, value2);
...
static cmr_int ov08a10_back_drv_access_val(cmr_handle handle, cmr_uint param) {
    ...
    case SENSOR_VAL_TYPE_GET_OIS_INFO:
        *((cmr_u8 *)param_ptr->pval) =
            (s_ov08a10_back_static_info->static_info.ois_supported);
        break;
    case SENSOR_VAL_TYPE_DUMP_TRACE:
        ret = ov08a10_back_drv_dump_trace(handle, param_ptr->pval);
        break;
    default:
        break;
    }
...
static cmr_int ov08a10_back_drv_identify(cmr_handle handle, cmr_uint param) {
    ...
    pid_value =
        hw_sensor_read_reg(sns_drv_cxt->hw_handle, OV08A10_BACK_PID_ADDR);

    if (OV08A10_BACK_PID_VALUE == pid_value) {
        ver_value =
            hw_sensor_read_reg(sns_drv_cxt->hw_handle, OV08A10_BACK_VER_ADDR);
 ...
 *============================================================================*/
static cmr_int ov08a10_back_drv_before_snapshot(cmr_handle handle,
                                                cmr_uint param) {
    ...
    ov08a10_back_drv_write_reg2sensor(handle,
                                      ov08a10_back_aec_info.frame_length);
 ...
 *============================================================================*/
static cmr_int ov08a10_back_drv_write_exposure(cmr_handle handle,
                                               cmr_uint param) {
    ...
    ov08a10_back_drv_calc_exposure(handle, exposure_line, dummy_line,
                                   size_index, &ov08a10_back_aec_info);
    ov08a10_back_drv_write_reg2sensor(handle,
                                      ov08a10_back_aec_info.frame_length);
    ov08a10_back_drv_write_reg2sensor(handle, ov08a10_back_aec_info.shutter);
 ...
 * you can change this function if it's necessary
 *============================================================================*/
static cmr_int ov08a10_back_drv_write_gain_value(cmr_handle handle,
                                                 cmr_uint param) {
    cmr_int ret_value = SENSOR_SUCCESS;
 ...
 * please don't change this function unless it's necessary
 *============================================================================*/
static cmr_int ov08a10_back_drv_read_aec_info(cmr_handle handle,
                                              cmr_uint param) {
    cmr_int ret_value = SENSOR_SUCCESS;
...
ov08a10_back_drv_handle_create(struct sensor_ic_drv_init_para *init_param,
    ...
    sensor_ic_set_match_resolution_info(
        sns_drv_cxt, ARRAY_SIZE(s_ov08a10_back_resolution_tab_raw),
        s_ov08a10_back_resolution_tab_raw);
    sensor_ic_set_match_trim_info(
        sns_drv_cxt, ARRAY_SIZE(s_ov08a10_back_resolution_trim_tab),
        s_ov08a10_back_resolution_trim_tab);
    sensor_ic_set_match_static_info(sns_drv_cxt,
                                    ARRAY_SIZE(s_ov08a10_back_static_info),
                                    s_ov08a10_back_static_info);
    sensor_ic_set_match_fps_info(sns_drv_cxt,
                                 ARRAY_SIZE(s_ov08a10_back_mode_fps_info),
...
static cmr_int ov08a10_back_drv_get_private_data(cmr_handle handle,
...
static struct sensor_ic_ops s_ov08a10_back_ops_tab = {
    ...
    .ext_ops = {
            [SENSOR_IOCTL_BEFORE_SNAPSHOT].ops =
                ov08a10_back_drv_before_snapshot,
