...
static cmr_int ov64b40_drv_get_pdaf_info(cmr_handle handle, cmr_u32 *param) {
    ...
    pdaf_info->pd_size_w = PREVIEW_TRIM_W;
    pdaf_info->pd_size_h = PREVIEW_TRIM_H;
...
static cmr_int ov64b40_drv_get_4in1_info(cmr_handle handle, cmr_u32 *param) {
    ...
    sn_4in1_info->limited_4in1_width = 4608; //4624; //
    sn_4in1_info->limited_4in1_height = 3456; //3472; //
