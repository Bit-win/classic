...
static SENSOR_REG_T ov9282_grp_hold_start_reg[] = {

};

static struct sensor_i2c_reg_tab ov9282_grp_hold_start_tab = {
    .settings = ov9282_grp_hold_start_reg,
    .size = ARRAY_SIZE(ov9282_grp_hold_start_reg),
};

static SENSOR_REG_T ov9282_grp_hold_end_reg[] = {

};

static struct sensor_i2c_reg_tab ov9282_grp_hold_end_tab = {
    .settings = ov9282_grp_hold_end_reg,
    .size = ARRAY_SIZE(ov9282_grp_hold_end_reg),
};
...
static struct sensor_aec_i2c_tag ov9282_aec_info = {
    ...
    .grp_hold_start = &ov9282_grp_hold_start_tab,
    .grp_hold_end = &ov9282_grp_hold_end_tab,
};
