...
static const cmr_u16 ov08a10_pd_is_right[] = {1, 0, 0, 1};

static const cmr_u16 ov08a10_pd_col[] = {14, 14, 6, 6};

static const cmr_u16 ov08a10_pd_row[] = {2, 6, 10, 14};

static const struct pd_pos_info ov08a10_pd_pos_l[] = {
    {14, 6}, {6, 10},
};

static const struct pd_pos_info ov08a10_pd_pos_r[] = {
    {14, 2}, {6, 14},
};
static const cmr_u32 ov08a10_pd_sns_mode[] = {
    SENSOR_PDAF_MODE_DISABLE, SENSOR_PDAF_MODE_DISABLE,
    SENSOR_PDAF_MODE_DISABLE, SENSOR_PDAF_MODE_ENABLE
};

struct sensor_pdaf_info ov08a10_pdaf_info_array[] = {
    ...
    {
	.pd_is_right = (cmr_u16 *)ov08a10_pd_is_right,
	.pd_pos_row = (cmr_u16 *)ov08a10_pd_row,
	.pd_pos_col = (cmr_u16 *)ov08a10_pd_col,
	.pd_pos_r = (struct pd_pos_info *)ov08a10_pd_pos_r,
	.pd_pos_l = (struct pd_pos_info *)ov08a10_pd_pos_l,
	.pd_pos_size = NUMBER_OF_ARRAY(ov08a10_pd_pos_r),
	.pd_offset_x = 0,
	.pd_offset_y = 8,
	.pd_end_x = 3264,
	.pd_end_y = 2448,
...
static struct sensor_pdaf_info_tab ov08a10_pdaf_info_tab = {
    .sns_mode_num = NUMBER_OF_ARRAY(ov08a10_pd_sns_mode),
	.pd_sns_mode = ov08a10_pd_sns_mode,
	.pdaf_init_index = 3,
	.pd_init_size_w = SNAPSHOT_WIDTH,
	.pd_init_size_h = SNAPSHOT_HEIGHT,
	.pd_info_tab = ov08a10_pdaf_info_array,
};
...
static cmr_int ov08a10_drv_get_pdaf_info(cmr_handle handle, cmr_u32 *param) {
    ...
    pdaf_info_tab->sns_mode_num = ov08a10_pdaf_info_tab.sns_mode_num;
    pdaf_info_tab->pd_sns_mode = ov08a10_pdaf_info_tab.pd_sns_mode;
    pdaf_info_tab->pdaf_init_index = ov08a10_pdaf_info_tab.pdaf_init_index;
    pdaf_info_tab->pd_init_size_w = ov08a10_pdaf_info_tab.pd_init_size_w;
    pdaf_info_tab->pd_init_size_h = ov08a10_pdaf_info_tab.pd_init_size_h;
    pdaf_info_tab->pd_info_tab = ov08a10_pdaf_info_tab.pd_info_tab;

    pd_info_num = ov08a10_pdaf_info_tab.sns_mode_num;
