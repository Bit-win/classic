...
static SENSOR_REG_T ov08a10_grp_hold_start_reg[] = {
    {0x3208, 0x00},
};

static struct sensor_i2c_reg_tab ov08a10_grp_hold_start_tab = {
    .settings = ov08a10_grp_hold_start_reg,
    .size = ARRAY_SIZE(ov08a10_grp_hold_start_reg),
};

static SENSOR_REG_T ov08a10_grp_hold_end_reg[] = {
    {0x3208, 0x10}, {0x3208, 0xa0},
};

static struct sensor_i2c_reg_tab ov08a10_grp_hold_end_tab = {
    .settings = ov08a10_grp_hold_end_reg,
    .size = ARRAY_SIZE(ov08a10_grp_hold_end_reg),
};
...
static struct sensor_aec_i2c_tag ov08a10_aec_info = {
    ...
    .grp_hold_start = &ov08a10_grp_hold_start_tab,
    .grp_hold_end = &ov08a10_grp_hold_end_tab,
};
