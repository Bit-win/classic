...
static SENSOR_REG_T ov13850r2a_grp_hold_start_reg[] = {

};

static struct sensor_i2c_reg_tab ov13850r2a_grp_hold_start_tab = {
    .settings = ov13850r2a_grp_hold_start_reg,
    .size = ARRAY_SIZE(ov13850r2a_grp_hold_start_reg),
};

static SENSOR_REG_T ov13850r2a_grp_hold_end_reg[] = {

};

static struct sensor_i2c_reg_tab ov13850r2a_grp_hold_end_tab = {
    .settings = ov13850r2a_grp_hold_end_reg,
    .size = ARRAY_SIZE(ov13850r2a_grp_hold_end_reg),
};
...
static struct sensor_aec_i2c_tag ov13850r2a_aec_info = {
    ...
    .grp_hold_start = &ov13850r2a_grp_hold_start_tab,
    .grp_hold_end = &ov13850r2a_grp_hold_end_tab,
};
