...
static SENSOR_REG_T ov12a1q_grp_hold_start_reg[] = {

};

static struct sensor_i2c_reg_tab ov12a1q_grp_hold_start_tab = {
    .settings = ov12a1q_grp_hold_start_reg,
    .size = ARRAY_SIZE(ov12a1q_grp_hold_start_reg),
};

static SENSOR_REG_T ov12a1q_grp_hold_end_reg[] = {

};

static struct sensor_i2c_reg_tab ov12a1q_grp_hold_end_tab = {
    .settings = ov12a1q_grp_hold_end_reg,
    .size = ARRAY_SIZE(ov12a1q_grp_hold_end_reg),
};
...
static struct sensor_aec_i2c_tag ov12a10_aec_info = {
    ...
    .grp_hold_start = &ov12a1q_grp_hold_start_tab,
    .grp_hold_end = &ov12a1q_grp_hold_end_tab,
};
