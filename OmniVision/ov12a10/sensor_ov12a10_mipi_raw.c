...
static const struct pd_pos_info ov12a10_pd_pos_l[] = {
    {14, 6}, {6, 10},
};

static const struct pd_pos_info ov12a10_pd_pos_r[] = {
    {14, 2}, {6, 14},
};
#endif
static const cmr_u32 ov12a10_pd_sns_mode[] = {0, 0, 0, 1};
#define PDAF_BLOCK_SIZE_W 16
#define PDAF_BLOCK_SIZE_H 16

struct sensor_pdaf_info ov12a10_pdaf_info_array[] = {
    ...
    {
	.pd_is_right = (cmr_u16 *)ov12a10_pd_is_right,
	.pd_pos_row = (cmr_u16 *)ov12a10_pd_row,
	.pd_pos_col = (cmr_u16 *)ov12a10_pd_col,
	.pd_pos_r = (struct pd_pos_info *)ov12a10_pd_pos_r,
	.pd_pos_l = (struct pd_pos_info *)ov12a10_pd_pos_l,
	.pd_pos_size = NUMBER_OF_ARRAY(ov12a10_pd_pos_r),
	.pd_offset_x = 0,
	.pd_offset_y = 0,
...
static struct sensor_pdaf_info_tab ov12a10_pdaf_info_tab = {
    .sns_mode_num = NUMBER_OF_ARRAY(ov12a10_pd_sns_mode),
	.pd_sns_mode = ov12a10_pd_sns_mode,
	.pdaf_init_index = 3,
	.pd_init_size_w = SNAPSHOT_WIDTH,
	.pd_init_size_h = SNAPSHOT_HEIGHT,
	.pd_info_tab = ov12a10_pdaf_info_array,
};

static cmr_int ov12a10_drv_get_pdaf_info(cmr_handle handle, void *param) {
    cmr_int rtn = SENSOR_SUCCESS;
    ...
    pdaf_info_tab->sns_mode_num = ov12a10_pdaf_info_tab.sns_mode_num;
    pdaf_info_tab->pd_sns_mode = ov12a10_pdaf_info_tab.pd_sns_mode;
    pdaf_info_tab->pdaf_init_index = ov12a10_pdaf_info_tab.pdaf_init_index;
    pdaf_info_tab->pd_init_size_w = ov12a10_pdaf_info_tab.pd_init_size_w;
    pdaf_info_tab->pd_init_size_h = ov12a10_pdaf_info_tab.pd_init_size_h;
    pdaf_info_tab->pd_info_tab = ov12a10_pdaf_info_tab.pd_info_tab;

    pd_info_num = ov12a10_pdaf_info_tab.sns_mode_num;
...
static cmr_u8 ov12a10_snspid_is_init = 0;
static cmr_int ov12a10_drv_save_snspid(cmr_handle handle) {
    SENSOR_IC_CHECK_HANDLE(handle);
    struct sensor_ic_drv_cxt *sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
    cmr_u8 snspid[32] = {0};
...
static cmr_int ov12a10_drv_identify(cmr_handle handle, cmr_uint param) {
    ...
    if (ov12a10_PID_VALUE == pid_value) {
        ...
        if (ov12a10_VER_VALUE == ver_value) {
            ...
            if (!ov12a10_snspid_is_init) {
                ov12a10_drv_save_snspid(handle);
            } 
        } else {
