...
#define LOG_TAG "ov8856_front_ts_4lane"
#include <utils/Log.h>
#include "sensor.h"
...
#define VENDOR_NUM 1
#define SENSOR_NAME "ov8856_front_ts"
...
static SENSOR_REG_T ov8856_grp_hold_start_reg[] = {

};

static struct sensor_i2c_reg_tab ov8856_grp_hold_start_tab = {
    .settings = ov8856_grp_hold_start_reg,
    .size = ARRAY_SIZE(ov8856_grp_hold_start_reg),
};


static SENSOR_REG_T ov8856_grp_hold_end_reg[] = {

};

static struct sensor_i2c_reg_tab ov8856_grp_hold_end_tab = {
    .settings = ov8856_grp_hold_end_reg,
    .size = ARRAY_SIZE(ov8856_grp_hold_end_reg),
};
...
static struct sensor_aec_i2c_tag ov8856_aec_info = {
    ...
    .grp_hold_start = &ov8856_grp_hold_start_tab,
    .grp_hold_end = &ov8856_grp_hold_end_tab,
};
...
SENSOR_INFO_T g_ov8856_shine_mipi_raw_info = {
    ...
    .sensor_version_info = (cmr_s8 *)"ov8856_front_ts",
};
