...
static SENSOR_REG_T ov8858_grp_hold_start_reg[] = {

};

static struct sensor_i2c_reg_tab ov8858_grp_hold_start_tab = {
    .settings = ov8858_grp_hold_start_reg,
    .size = ARRAY_SIZE(ov8858_grp_hold_start_reg),
};

static SENSOR_REG_T ov8858_grp_hold_end_reg[] = {

};

static struct sensor_i2c_reg_tab ov8858_grp_hold_end_tab = {
    .settings = ov8858_grp_hold_end_reg,
    .size = ARRAY_SIZE(ov8858_grp_hold_end_reg),
};
...
static struct sensor_aec_i2c_tag ov8858_aec_info = {
    ...
    .grp_hold_start = &ov8858_grp_hold_start_tab,
    .grp_hold_end = &ov8858_grp_hold_end_tab,
};
