...
static SENSOR_REG_T gc8034_grp_hold_start_reg[] = {

};

static struct sensor_i2c_reg_tab gc8034_grp_hold_start_tab = {
    .settings = gc8034_grp_hold_start_reg,
    .size = ARRAY_SIZE(gc8034_grp_hold_start_reg),
};

static SENSOR_REG_T gc8034_grp_hold_end_reg[] = {

};

static struct sensor_i2c_reg_tab gc8034_grp_hold_end_tab = {
    .settings = gc8034_grp_hold_end_reg,
    .size = ARRAY_SIZE(gc8034_grp_hold_end_reg),
};
...
static struct sensor_aec_i2c_tag gc8034_aec_info = {
    ...
    .grp_hold_start = &gc8034_grp_hold_start_tab,
    .grp_hold_end = &gc8034_grp_hold_end_tab,
};
