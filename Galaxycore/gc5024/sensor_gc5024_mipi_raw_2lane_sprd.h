...
static SENSOR_REG_T gc5024_grp_hold_start_reg[] = {

};

static struct sensor_i2c_reg_tab gc5024_grp_hold_start_tab = {
    .settings = gc5024_grp_hold_start_reg,
    .size = ARRAY_SIZE(gc5024_grp_hold_start_reg),
};

static SENSOR_REG_T gc5024_grp_hold_end_reg[] = {

};

static struct sensor_i2c_reg_tab gc5024_grp_hold_end_tab = {
    .settings = gc5024_grp_hold_end_reg,
    .size = ARRAY_SIZE(gc5024_grp_hold_end_reg),
};
...
static struct sensor_aec_i2c_tag gc5024_aec_info = {
    ...
    .grp_hold_start = &gc5024_grp_hold_start_tab,
    .grp_hold_end = &gc5024_grp_hold_end_tab,
};
