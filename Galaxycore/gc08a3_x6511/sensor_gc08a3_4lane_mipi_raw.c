...
#define LOG_TAG "gc08a3_4lane"

#include "sensor_gc08a3_4lane_mipi_raw.h"
...
static void gc08a3_drv_write_reg2sensor(cmr_handle handle,
 ...
 * please modify this function acording your spec
 *============================================================================*/
static void gc08a3_drv_write_gain(cmr_handle handle,
    ...
    SENSOR_LOGI("isp_gain:0x%x, sensor_again:0x%x, sensor_gain:NULL", isp_gain,
                sensor_again);
}

static void gc08a3_drv_write_frame_length(cmr_handle handle,
                                          struct sensor_aec_i2c_tag *aec_info,
                                          cmr_u32 frame_len) {
    SENSOR_IC_CHECK_PTR_VOID(aec_info);
    SENSOR_IC_CHECK_HANDLE_VOID(handle);
 ...
 * please modify this function acording your spec
 *============================================================================*/
static void gc08a3_drv_write_shutter(cmr_handle handle,
                                     struct sensor_aec_i2c_tag *aec_info,
                                     cmr_u32 shutter) {
    SENSOR_IC_CHECK_PTR_VOID(aec_info);
    SENSOR_IC_CHECK_HANDLE_VOID(handle);
 ...
 *============================================================================*/
static void gc08a3_drv_calc_exposure(cmr_handle handle, cmr_u32 shutter,
    ...
    SENSOR_LOGI("mode = %d, exposure_line = %d, dummy_line= %d, fps= %f", mode,
                shutter, dummy_line, fps);
...
static void gc08a3_drv_calc_gain(cmr_handle handle, cmr_uint isp_gain,
                                 struct sensor_aec_i2c_tag *aec_info) {
    SENSOR_IC_CHECK_HANDLE_VOID(handle);
    struct sensor_ic_drv_cxt *sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
    ...
    gc08a3_drv_write_gain(handle, aec_info, isp_gain);
...
static cmr_int gc08a3_drv_power_on(cmr_handle handle, cmr_uint power_on) {
    ...
    SENSOR_LOGI("X, (1:on, 0:off): %lu", power_on);
...
static cmr_int gc08a3_drv_get_static_info(cmr_handle handle, cmr_u32 *param) {
    ...
    ex_info->sensor_version_info =
        (cmr_s8 *)g_gc08a3_mipi_raw_info.sensor_version_info;
...
static cmr_int gc08a3_drv_before_snapshot(cmr_handle handle, cmr_uint param) {
    ...
    gc08a3_drv_calc_exposure(handle, cap_shutter, 0, capture_mode,
                             &gc08a3_aec_info);
...
static cmr_int gc08a3_drv_write_exposure(cmr_handle handle, cmr_uint param) {
    ...
    gc08a3_drv_calc_exposure(handle, exposure_line, dummy_line, size_index,
                             &gc08a3_aec_info);
    gc08a3_drv_write_reg2sensor(handle, gc08a3_aec_info.frame_length);
    gc08a3_drv_write_reg2sensor(handle, gc08a3_aec_info.shutter);
...
static cmr_int gc08a3_drv_read_aec_info(cmr_handle handle, cmr_uint param) {
    ...
    gc08a3_drv_calc_exposure(handle, exposure_line, dummy_line, mode,
                             &gc08a3_aec_info);
...
static cmr_int gc08a3_drv_handle_create(struct sensor_ic_drv_init_para *init_param,
    ...
    gc08a3_drv_write_frame_length(
        sns_drv_cxt, &gc08a3_aec_info,
        sns_drv_cxt->sensor_ev_info.preview_framelength);
    gc08a3_drv_write_gain(sns_drv_cxt, &gc08a3_aec_info,
                          sns_drv_cxt->sensor_ev_info.preview_gain);
    gc08a3_drv_write_shutter(sns_drv_cxt, &gc08a3_aec_info,
                             sns_drv_cxt->sensor_ev_info.preview_shutter);

    sensor_ic_set_match_module_info(sns_drv_cxt,
                                    ARRAY_SIZE(s_gc08a3_module_info_tab),
                                    s_gc08a3_module_info_tab);
    sensor_ic_set_match_resolution_info(sns_drv_cxt,
                                        ARRAY_SIZE(s_gc08a3_resolution_tab_raw),
                                        s_gc08a3_resolution_tab_raw);
    sensor_ic_set_match_trim_info(sns_drv_cxt,
                                  ARRAY_SIZE(s_gc08a3_resolution_trim_tab),
                                  s_gc08a3_resolution_trim_tab);

    sensor_ic_set_match_static_info(
        sns_drv_cxt, ARRAY_SIZE(s_gc08a3_static_info), s_gc08a3_static_info);
    sensor_ic_set_match_fps_info(sns_drv_cxt,
                                 ARRAY_SIZE(s_gc08a3_mode_fps_info),
                                 s_gc08a3_mode_fps_info);
...
static cmr_int gc08a3_drv_get_private_data(cmr_handle handle, cmr_uint cmd,
                                           void **param) {
    cmr_int ret = SENSOR_SUCCESS;
    SENSOR_IC_CHECK_HANDLE(handle);
    SENSOR_IC_CHECK_PTR(param);
...
void *sensor_ic_open_lib(void) { return &g_gc08a3_mipi_raw_info; }
