...
#endif
/*add the parameter of fov for the gc08a3. songcen@transsion.com,2021-05-17*/
typedef struct
{
    cmr_u8 nSnsId;
    cmr_u32 FocalLength;
...
SENSOR_EXIF_INFO p_gc08a3_4lane_mipi_exif_info[] =
#ifndef SENSOREXIF_LIST
{
    {0, 282, 20},
        ...
        SENSOREXIF_LIST;
#endif
static EXIF_SPEC_PIC_TAKING_COND_T s_gc08a3_exif_info;
/*add end. songcen@transsion.com,2021-05-17*/
...
static struct sensor_res_tab_info s_gc08a3_resolution_tab_raw[VENDOR_NUM] = {
    {.module_id = MODULE_SUNNY,
     .reg_tab = {{ADDR_AND_LEN_OF_ARRAY(gc08a3_init_setting), PNULL, 0,
...
static SENSOR_REG_T gc08a3_grp_hold_start_reg[] = {

};

static struct sensor_i2c_reg_tab gc08a3_grp_hold_start_tab = {
    .settings = gc08a3_grp_hold_start_reg,
    .size = ARRAY_SIZE(gc08a3_grp_hold_start_reg),
};

static SENSOR_REG_T gc08a3_grp_hold_end_reg[] = {

};

static struct sensor_i2c_reg_tab gc08a3_grp_hold_end_tab = {
    .settings = gc08a3_grp_hold_end_reg,
    .size = ARRAY_SIZE(gc08a3_grp_hold_end_reg),
};
...
static struct sensor_aec_i2c_tag gc08a3_aec_info = {
    ...
    .grp_hold_start = &gc08a3_grp_hold_start_tab,
    .grp_hold_end = &gc08a3_grp_hold_end_tab,
};
...
static struct sensor_module_info s_gc08a3_module_info_tab[VENDOR_NUM] = {
    {.module_id = MODULE_SUNNY,
     .module_info = {.major_i2c_addr = 0x62 >> 1,
...
struct sensor_raw_info *s_gc08a3_mipi_raw_info_ptr = NULL;
...
SENSOR_INFO_T g_gc08a3_mipi_raw_info = {
    ...
    .identify_count = 1,
    .identify_code = {{.reg_addr = GC08A3_PID_ADDR,
                       .reg_value = GC08A3_PID_VALUE},
                      {.reg_addr = GC08A3_VER_ADDR,
                       .reg_value = GC08A3_VER_VALUE}},
