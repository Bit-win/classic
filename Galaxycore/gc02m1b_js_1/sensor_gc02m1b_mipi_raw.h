...
static SENSOR_REG_T gc02m1b_grp_hold_start_reg[] = {

};

static struct sensor_i2c_reg_tab gc02m1b_grp_hold_start_tab = {
    .settings = gc02m1b_grp_hold_start_reg,
    .size = ARRAY_SIZE(gc02m1b_grp_hold_start_reg),
};

static SENSOR_REG_T gc02m1b_grp_hold_end_reg[] = {

};

static struct sensor_i2c_reg_tab gc02m1b_grp_hold_end_tab = {
    .settings = gc02m1b_grp_hold_end_reg,
    .size = ARRAY_SIZE(gc02m1b_grp_hold_end_reg),
};
...
static struct sensor_aec_i2c_tag gc02m1b_aec_info = {
    ...
    .grp_hold_start = &gc02m1b_grp_hold_start_tab,
    .grp_hold_end = &gc02m1b_grp_hold_end_tab,	
};
