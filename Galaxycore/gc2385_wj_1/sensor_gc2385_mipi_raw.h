...
static SENSOR_REG_T gc2385_grp_hold_start_reg[] = {

};

static struct sensor_i2c_reg_tab gc2385_grp_hold_start_tab = {
    .settings = gc2385_grp_hold_start_reg,
    .size = ARRAY_SIZE(gc2385_grp_hold_start_reg),
};

static SENSOR_REG_T gc2385_grp_hold_end_reg[] = {

};

static struct sensor_i2c_reg_tab gc2385_grp_hold_end_tab = {
    .settings = gc2385_grp_hold_end_reg,
    .size = ARRAY_SIZE(gc2385_grp_hold_end_reg),
};
...
static struct sensor_aec_i2c_tag gc2385_aec_info = {
    ...
    .grp_hold_start = &gc2385_grp_hold_start_tab,
    .grp_hold_end = &gc2385_grp_hold_end_tab,
};
