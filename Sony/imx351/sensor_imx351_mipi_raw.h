...
static SENSOR_REG_T imx351_grp_hold_start_reg[] = {
    {0x0104, 0x01},
};

static struct sensor_i2c_reg_tab imx351_grp_hold_start_tab = {
    .settings = imx351_grp_hold_start_reg,
    .size = ARRAY_SIZE(imx351_grp_hold_start_reg),
};

static SENSOR_REG_T imx351_grp_hold_end_reg[] = {
    {0x0104, 0x00},
};

static struct sensor_i2c_reg_tab imx351_grp_hold_end_tab = {
    .settings = imx351_grp_hold_end_reg,
    .size = ARRAY_SIZE(imx351_grp_hold_end_reg),
};
...
static struct sensor_aec_i2c_tag imx351_aec_info = {
    ...
    .grp_hold_start = &imx351_grp_hold_start_tab,
    .grp_hold_end = &imx351_grp_hold_end_tab,
};
