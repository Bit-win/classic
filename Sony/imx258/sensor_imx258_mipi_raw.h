...
static SENSOR_REG_T imx258_grp_hold_start_reg[] = {

};

static struct sensor_i2c_reg_tab imx258_grp_hold_start_tab = {
    .settings = imx258_grp_hold_start_reg,
    .size = ARRAY_SIZE(imx258_grp_hold_start_reg),
};

static SENSOR_REG_T imx258_grp_hold_end_reg[] = {

};

static struct sensor_i2c_reg_tab imx258_grp_hold_end_tab = {
    .settings = imx258_grp_hold_end_reg,
    .size = ARRAY_SIZE(imx258_grp_hold_end_reg),
};
...
static struct sensor_aec_i2c_tag imx258_aec_info = {
    ...
    .grp_hold_start = &imx258_grp_hold_start_tab,
    .grp_hold_end = &imx258_grp_hold_end_tab,
};
