...
static SENSOR_REG_T imx362_grp_hold_start_reg[] = {

};

static struct sensor_i2c_reg_tab imx362_grp_hold_start_tab = {
    .settings = imx362_grp_hold_start_reg,
    .size = ARRAY_SIZE(imx362_grp_hold_start_reg),
};

static SENSOR_REG_T imx362_grp_hold_end_reg[] = {

};

static struct sensor_i2c_reg_tab imx362_grp_hold_end_tab = {
    .settings = imx362_grp_hold_end_reg,
    .size = ARRAY_SIZE(imx362_grp_hold_end_reg),
};
...
static struct sensor_aec_i2c_tag imx362_aec_info = {
    ...
    .grp_hold_start = &imx362_grp_hold_start_tab,
    .grp_hold_end = &imx362_grp_hold_end_tab,
};
