...
static const SENSOR_REG_T s5k3l8xxm3r_720p_setting[] = {
...
static struct sensor_res_tab_info s_s5k3l8xxm3r_resolution_tab_raw[VENDOR_NUM] =
    {
        {.module_id = MODULE_SUNNY,
         .reg_tab = {{ADDR_AND_LEN_OF_ARRAY(s5k3l8xxm3r_init_setting), PNULL, 0,
                      .width = 0, .height = 0, .xclk_to_sensor = EX_MCLK,
                      .image_format = SENSOR_IMAGE_FORMAT_RAW},

                     {ADDR_AND_LEN_OF_ARRAY(s5k3l8xxm3r_video_setting), PNULL,
                      0, .width = VIDEO_WIDTH, .height = VIDEO_HEIGHT,
                      .xclk_to_sensor = EX_MCLK,
                      .image_format = SENSOR_IMAGE_FORMAT_RAW},

                     {ADDR_AND_LEN_OF_ARRAY(s5k3l8xxm3r_720p_setting), PNULL, 0,
                      .width = VIDEO_WIDTH, .height = VIDEO_HEIGHT,
                      .xclk_to_sensor = EX_MCLK,
                      .image_format = SENSOR_IMAGE_FORMAT_RAW},

                     {ADDR_AND_LEN_OF_ARRAY(s5k3l8xxm3r_preview_setting), PNULL,
                      0, .width = PREVIEW_WIDTH, .height = PREVIEW_HEIGHT,
                      .xclk_to_sensor = EX_MCLK,
                      .image_format = SENSOR_IMAGE_FORMAT_RAW},

                     {ADDR_AND_LEN_OF_ARRAY(s5k3l8xxm3r_snapshot_setting),
...
static SENSOR_TRIM_T
    s_s5k3l8xxm3r_resolution_trim_tab[VENDOR_NUM] =
        {
            {.module_id = MODULE_SUNNY,
             .trim_info =
                 {
...
static SENSOR_REG_T s5k3l8_grp_hold_start_reg[] = {

};

static struct sensor_i2c_reg_tab s5k3l8_grp_hold_start_tab = {
    .settings = s5k3l8_grp_hold_start_reg,
    .size = ARRAY_SIZE(s5k3l8_grp_hold_start_reg),
};


static SENSOR_REG_T s5k3l8_grp_hold_end_reg[] = {

};

static struct sensor_i2c_reg_tab s5k3l8_grp_hold_end_tab = {
    .settings = s5k3l8_grp_hold_end_reg,
    .size = ARRAY_SIZE(s5k3l8_grp_hold_end_reg),
};
...
static struct sensor_aec_i2c_tag s5k3l8xxm3r_aec_info = {
    ...
    .grp_hold_start = &s5k3l8_grp_hold_start_tab,
    .grp_hold_end = &s5k3l8_grp_hold_end_tab,
};
...
struct sensor_raw_info *s_s5k3l8xxm3r_mipi_raw_info_ptr =
    &s_s5k3l8xxm3r_mipi_raw_info;
...
SENSOR_INFO_T g_s5k3l8xxm3r_mipi_raw_info = {
    ...
    .identify_count = 1,
    .identify_code = {{.reg_addr = s5k3l8xxm3r_PID_ADDR,
                       .reg_value = s5k3l8xxm3r_PID_VALUE},
                      {.reg_addr = s5k3l8xxm3r_VER_ADDR,
                       .reg_value = s5k3l8xxm3r_VER_VALUE}},
