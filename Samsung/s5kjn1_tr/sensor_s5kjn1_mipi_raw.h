...
#define s5kjn1_PID_VALUE 0x38e1
...
#define SNAPSHOT_WIDTH 8160
#define SNAPSHOT_HEIGHT 6144
#define SLOWMOTION_WIDTH 2040
#define SLOWMOTION_HEIGHT 1536
...
#define SLOWMOTION_MIPI_PER_LANE_BPS 1632     /* 4*Mipi clk */

/*line time unit: 1ns*/
#define PREVIEW_LINE_TIME 8185
#define SNAPSHOT_LINE_TIME 15625
#define SLOWMOTION_LINE_TIME 4751

/* frame length*/
#define PREVIEW_FRAME_LENGTH 4054
#define SNAPSHOT_FRAME_LENGTH 6400
#define SLOWMOTION_FRAME_LENGTH 1754

/* please ref your spec */
#define FRAME_OFFSET 5
#define SENSOR_MAX_GAIN 0x0800
#define SENSOR_MAX_GAIN_REMOSAIC 0x0200
...
static const SENSOR_REG_T s5kjn1_slowmotion_setting[] = {
    {0x6028, 0x2400},
    {0x602A, 0x1A28},
    {0x6F12, 0x4C00},
    {0x602A, 0x065A},
...
static struct sensor_res_tab_info s_s5kjn1_resolution_tab_raw[VENDOR_NUM] = {
    {.module_id = MODULE_SUNNY,
        .reg_tab = {
            ...
            .xclk_to_sensor = EX_MCLK, .image_format = SENSOR_IMAGE_FORMAT_RAW},
            {ADDR_AND_LEN_OF_ARRAY(s5kjn1_slowmotion_setting), PNULL, 0,
...
static EXIF_SPEC_PIC_TAKING_COND_T s_s5kjn1_exif_info;
/*static SENSOR_FOV_INFO_T s_s5kjn1_transsion_fov_info[] = {
#ifdef s5kjn1_transsion_1711
    {
        .module_id = MODULE_ID_04,
        .f_num = 160,
        .focal_lengths = 4.11
    },
#endif
#ifdef s5kjn1_transsion_1715
    {
        .module_id = MODULE_ID_60,
        .f_num = 160,
        .focal_lengths = 4.09
    }
#endif
...
static SENSOR_STATIC_INFO_T s_s5kjn1_static_info[VENDOR_NUM] = {
    {.module_id = MODULE_SUNNY,  //s5kjn1_1711
     .static_info = {.f_num = 160,
                    ...
                    .max_adgain = 8,
                    .ois_supported = 0,
                    .pdaf_supported = SENSOR_PDAF_TYPE2_ENABLE,
                    .exp_valid_frame_num = 1,
                    .clamp_level = 64,
                    .adgain_valid_frame_num = 1,
                    .fov_info = {{5.222f, 3.932f}, 4.11f}}
    },
};
...
SENSOR_INFO_T g_s5kjn1_mipi_raw_info = {
    ...
    .sensor_version_info = (cmr_s8 *)"s5kjn1_trr_v1",
};
