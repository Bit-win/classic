...
static SENSOR_REG_T s5k4h7_grp_hold_start_reg[] = {

};

static struct sensor_i2c_reg_tab s5k4h7_grp_hold_start_tab = {
    .settings = s5k4h7_grp_hold_start_reg,
    .size = ARRAY_SIZE(s5k4h7_grp_hold_start_reg),
};


static SENSOR_REG_T s5k4h7_grp_hold_end_reg[] = {

};

static struct sensor_i2c_reg_tab s5k4h7_grp_hold_end_tab = {
    .settings = s5k4h7_grp_hold_end_reg,
    .size = ARRAY_SIZE(s5k4h7_grp_hold_end_reg),
};
...
static struct sensor_aec_i2c_tag s5k4h7_aec_info = {
    ...
    .grp_hold_start = &s5k4h7_grp_hold_start_tab,
    .grp_hold_end = &s5k4h7_grp_hold_end_tab,
};
