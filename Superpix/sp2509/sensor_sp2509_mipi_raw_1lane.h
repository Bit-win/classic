...
#ifndef _SENSOR_SP2509_MIPI_RAW_H_
#define _SENSOR_SP2509_MIPI_RAW_H_
...
#include "parameters/sensor_sp2509_raw_param_main.c"
...
static struct sensor_res_tab_info s_sp2509_resolution_tab_raw[VENDOR_NUM] = {
	{
      .module_id = MODULE_SUNNY,
      .reg_tab = {
        {ADDR_AND_LEN_OF_ARRAY(sp2509_init_setting), PNULL, 0,
        .width = 0, .height = 0,
        .xclk_to_sensor = EX_MCLK, .image_format = SENSOR_IMAGE_FORMAT_RAW},
		
        {ADDR_AND_LEN_OF_ARRAY(sp2509_preview_setting), PNULL, 0,
        .width = PREVIEW_WIDTH, .height = PREVIEW_HEIGHT,
        .xclk_to_sensor = EX_MCLK, .image_format = SENSOR_IMAGE_FORMAT_RAW},

        {ADDR_AND_LEN_OF_ARRAY(sp2509_snapshot_setting), PNULL, 0,
...
static SENSOR_TRIM_T s_sp2509_resolution_trim_tab[VENDOR_NUM] = {
	{
     .module_id = MODULE_SUNNY,
     .trim_info = {
...
static SENSOR_REG_T sp2509_shutter_reg[] = {
    {0xfd, 0x01}, 
	{0x03, 0x07}, 
	{0x04, 0x85}, 
	{0x01, 0x01}, 
...
static SENSOR_REG_T sp2509_again_reg[] = {
    {0xfd, 0x01}, 
	{0x24, 0xf0}, 
	{0x01, 0x01}, 
...
static SENSOR_REG_T sp2509_dgain_reg[] = {
   
};

static struct sensor_i2c_reg_tab sp2509_dgain_tab = {
    .settings = sp2509_dgain_reg, 
	.size = ARRAY_SIZE(sp2509_dgain_reg),
};

static SENSOR_REG_T sp2509_frame_length_reg[] = {
...
static SENSOR_STATIC_INFO_T s_sp2509_static_info[VENDOR_NUM] = {
    {.module_id = MODULE_SUNNY,
     .static_info = {
        .f_num = 200,
        .focal_length = 354,
...
static SENSOR_MODE_FPS_INFO_T s_sp2509_mode_fps_info[VENDOR_NUM] = {
    {.module_id = MODULE_SUNNY,
       {.is_init = 0,
...
static struct sensor_module_info s_sp2509_module_info_tab[VENDOR_NUM] = {
    {.module_id = MODULE_SUNNY,
     .module_info = {
...
SENSOR_INFO_T g_sp2509_mipi_raw_info = {
    ...
    .identify_count = 1,
    .identify_code =
        {{ .reg_addr = sp2509_PID_ADDR, .reg_value = sp2509_PID_VALUE},
         { .reg_addr = sp2509_VER_ADDR, .reg_value = sp2509_VER_VALUE}},
    ...
    .module_info_tab = s_sp2509_module_info_tab,
    .module_info_tab_size = ARRAY_SIZE(s_sp2509_module_info_tab),

    .resolution_tab_info_ptr = s_sp2509_resolution_tab_raw,
    .sns_ops = &s_sp2509_ops_tab,
    .raw_info_ptr = &s_sp2509_mipi_raw_info_ptr,

    .video_tab_info_ptr = NULL,
    .sensor_version_info = (cmr_s8 *)"sp2509_v1",
};
